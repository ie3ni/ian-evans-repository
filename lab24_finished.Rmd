...
154 observations, one area. As the median income rises the burgerly rate dereases. There is an inverse relationship between the median income and the burgerly rate.
...
ggplot(crimes_time_ca, aes(median_income,n/num_households )) +
  geom_point() +
...
Thesis: the overall crime rate and arrest rate are postively correlated. The median income has a left sckewed normal distribution. 
