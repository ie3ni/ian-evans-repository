...
```{r}
ggplot(mpg, aes(displ, hwy, color= "green")) +
...
ggplot(mpg, aes(displ,hwy)) + 
geom_point() +
geom_point(aes(displ,cty, color= "red")) 
```
...
ggtitle("Engine Size vs Highway and City Fuel Efficiency")
```
